    ...
    : QDialog(parent), result(0)
{
    ...
    connect(slider, &QSlider::valueChanged, this, &SliderDialog::onSliderValueChanged);
    connect(okButton, &QPushButton::clicked, this, &SliderDialog::onOkButtonClicked);
...
int SliderDialog::getValue() const
{
    return result;
}