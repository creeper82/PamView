...
{
public:
    static void loadToBitmap(Bitmap &bitmap, std::istream &stream, void (*progressHandler)(int) = nullptr);
    static void saveBitmapTo(Bitmap &bitmap, std::ostream &stream, FILETYPE filetype, void (*progressHandler)(int) = nullptr);
